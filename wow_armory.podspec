#
#  Be sure to run `pod spec lint wow_armory.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  s.description  = <<-DESC
                   A longer description of wow_armory in Markdown format.
  ...
  s.author             = { "Adam Greenfield" => "email@address.com" }
  # Or just: s.author    = "Adam Greenfield"
  # s.authors            = { "Adam Greenfield" => "email@address.com" }
  # s.social_media_url   = "http://twitter.com/Adam Greenfield"
